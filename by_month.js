...
async function getBanners() {
    let url = 'https://opensheet.elk.sh/1jTJHyJHcv9pDy4c_dZMRxE34QBbmmAC6P2c0106Ba_0/adByMonth';
    try {
...
async function renderByMonthAdText() {
  ...
  let adtext = await getBanners();
   ...
   document.querySelector('#monthlyTextAd').innerHTML = dTextAd;
   // <div id="monthTextAd"></div>  // to display advert
