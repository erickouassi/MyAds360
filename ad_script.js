...
let html = '';
 currentAd.forEach(adData => {
                let htmlSegment = `
                <div class="#" style="width:330px;height:auto;background-color:#F5F7FF;padding:5px;">
...
async function renderByRandomAdText() {
  ...
  // For random row 
  let html = '';
  let htmlSegment = `<div class="#" style="width:330px;height:auto;background-color:#F5F7FF;padding:5px;">
<span>${adData.adText}</span><br>
  <span>${adData.callToAction}</span> <a href='${adData.adURL}' rel='nofollow'>
